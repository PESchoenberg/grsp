...
;;   [Accessed 3 January 2022].
;; - [3] En.wikipedia.org. 2022. Polynomial interpolation - Wikipedia.
;;   [online]
...
;;;; grsp-chebyshev-node - Calculates Chebyshev polynomial root p_k1 of
;; p_n1 over the interval [p_a1, p_b1].
;;
;; Keywords:
;;
...
;; Keywords:
;;
;; - functions, interpolation, polynomials, lagrangian
;;
;; Parameters:
;;
;; - p_x1: x.
  ...
  (let ((res1 0.0)
    ...
    (let loop ((i1 (grsp-lm res2)))
	  ...
	  (begin (set! y1 (array-ref res2 i1 (+ (grsp-ln res2) 1)))
		 (set! res1 (+ res1
			       (* y1 (grsp-lagrange-bpoly p_x1 i1 res2))))
